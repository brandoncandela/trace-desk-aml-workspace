...
**[Open the AML workspace](https://brandon-usdt-workspace.brandon-d-candela.chatgpt.site/)**

Standalone project for bounded USDT tracing, analyst case files and QC review.

An AML review workspace with a Python evidence pipeline and a dependency-free JavaScript interface. Start with the verified saved example or query a new Ethereum address, expand observed counterparties, record your assessment, and export a handoff report. Built with AI assistance as an AML investigation portfolio project.
